...
type LocaleRepository(_context: ApiDbContext) =
    interface ILocaleRepository with
        override this.Delete(locale: Locale): EntityEntry<Locale> = 
            _context.Locales.Remove locale

        override this.Insert(locale: Locale): EntityEntry<Locale> = 
            _context.Locales.Add locale

        override this.Update(locale: Locale): EntityEntry<Locale> = 
